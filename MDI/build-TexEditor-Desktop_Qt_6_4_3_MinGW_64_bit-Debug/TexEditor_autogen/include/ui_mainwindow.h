...
""));
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/Resourse/align-center.png"), QSize(), QIcon::Normal, QIcon::Off);
        toolButton_8->setIcon(icon);

        gridLayout->addWidget(toolButton_8, 0, 8, 1, 1);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/Resourse/b.png"), QSize(), QIcon::Normal, QIcon::Off);
        toolButton_5->setIcon(icon1);

        gridLayout->addWidget(toolButton_5, 0, 6, 1, 1);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/Resourse/align-justify.png"), QSize(), QIcon::Normal, QIcon::Off);
        toolButton_10->setIcon(icon2);

        gridLayout->addWidget(toolButton_10, 0, 10, 1, 1);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/Resourse/scissors.png"), QSize(), QIcon::Normal, QIcon::Off);
        toolButton_13->setIcon(icon3);

        gridLayout->addWidget(toolButton_13, 0, 12, 1, 1);
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/Resourse/paste.png"), QSize(), QIcon::Normal, QIcon::Off);
        toolButton_12->setIcon(icon4);

        gridLayout->addWidget(toolButton_12, 0, 13, 1, 1);
        ...
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/Resourse/a.png"), QSize(), QIcon::Normal, QIcon::Off);
        toolButton_4->setIcon(icon5);

        gridLayout->addWidget(toolButton_4, 0, 5, 1, 1);
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/Resourse/copy-alt.png"), QSize(), QIcon::Normal, QIcon::Off);
        toolButton_11->setIcon(icon6);

        gridLayout->addWidget(toolButton_11, 0, 11, 1, 1);
        ...
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/Resourse/align-left.png"), QSize(), QIcon::Normal, QIcon::Off);
        toolButton_7->setIcon(icon7);

        gridLayout->addWidget(toolButton_7, 0, 7, 1, 1);
        ...
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/Resourse/symbol.png"), QSize(), QIcon::Normal, QIcon::Off);
        toolButton_9->setIcon(icon8);

        gridLayout->addWidget(toolButton_9, 0, 9, 1, 1);
        ...
        QIcon icon10;
        icon10.addFile(QString::fromUtf8(":/Resourse/angle-left.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon11;
        icon11.addFile(QString::fromUtf8(":/Resourse/document.png"), QSize(), QIcon::Normal, QIcon::Off);
        toolButton_2->setIcon(icon11);
        ...
        QIcon icon12;
        icon12.addFile(QString::fromUtf8(":/Resourse/check.png"), QSize(), QIcon::Normal, QIcon::Off);
...
#if QT_CONFIG(tooltip)
        toolButton_4->setToolTip(QCoreApplication::translate("MainWindow", "<html><head/><body><p>\350\256\276\347\275\256\345\255\227\344\275\223</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
